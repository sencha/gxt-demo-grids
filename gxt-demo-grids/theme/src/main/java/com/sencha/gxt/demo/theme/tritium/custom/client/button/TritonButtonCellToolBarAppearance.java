...
public class TritonButtonCellToolBarAppearance<M> extends TritonButtonCellAppearance<M> {
  ...
  public interface TritonButtonCellResources extends Css3ButtonResources {
    ...
    @Override
    @Source({"com/sencha/gxt/demo/theme/tritium/client/base/button/Css3ButtonCell.gss",
            "com/sencha/gxt/demo/theme/tritium/client/base/button/Css3ButtonCellToolBar.gss", "TritonButtonCellToolBar.gss"})
